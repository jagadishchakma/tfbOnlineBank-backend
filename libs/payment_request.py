...
from tfbOnlineBanking.utils import frontend_link,backend_link
def payment_request(amount,user):
        ...
        post_body['success_url'] = f"{backend_link}/accounts/deposit/success/"
        post_body['fail_url'] = f"{backend_link}/accounts/deposit/failed/"
        post_body['cancel_url'] = f"{backend_link}/accounts/deposit/cancel/"
